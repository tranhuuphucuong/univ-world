    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col group p-8 ml-20">
        ...
        <Cursor
          ...
          textClassName="group-hover:text-typo"
          text="Tyler Durden"
          style={{
            opacity: 1 - sliderXPercent * 0.015,
          }}
...
const Cover = ({
  ...
  return (
    <span
      className={cn(
        "border rounded-md px-1 py-0.5 mr-1 border-indigo-500 bg-indigo-500/10 text-typo",
        className
      )}
    >
      {children}
...
const Container = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "h-10  text-xs px-2 text-neutral-400  rounded-[5px] flex items-center justify-center bg-base shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)]"
        )}
      >
        {children}
      </div>
