        ...
        <div className="max-w-7xl mx-auto text-sm text-neutral-500 flex sm:flex-row flex-col justify-between items-start ">
          <div>
            ...
            <div className="mt-10">
              ...
              <a className="text-typo underline" href="https://aceternity.com">
                Aceternity
              </a>{" "}
              &{" "}
              <a className="text-typo underline" href="https://strapi.io">
                Strapi
              </a>
            </div>
            <div className="mt-2">
              ...
              ,{" "}
              <a className="text-typo underline" href="https://nextjs.org">
                Next.js
              </a>
              ,{" "}
              <a className="text-typo underline" href="https://tailwindcss.com">
                Tailwind CSS
              </a>
              ,{" "}
              <a
                className="text-typo underline"
