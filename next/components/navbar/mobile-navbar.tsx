  ...
  return (
    <div
      className={cn(
        ...
        showBackground &&
          " bg-base  shadow-[0px_-2px_0px_0px_var(--neutral-800),0px_2px_0px_0px_var(--neutral-800)]"
      )}
    >
      <Logo image={logo?.image} />

      <IoIosMenu className="text-typo h-6 w-6" onClick={() => setOpen(!open)} />
                ...
                {navItem.children && navItem.children.length > 0 ? (
                  <>
                    {navItem.children.map((childNavItem: any, idx: number) => (
                      ...
                      >
                        <span className="block text-typo">
                          {childNavItem.text}
                        </span>
                      </Link>
                    ))}
                  ...
                  <Link
                    ...
                    className="relative"
                  >
                    <span className="block text-[26px] text-typo">
                      {navItem.text}
                    </span>
                  </Link>
                )}
