    ...
    <Container className="h-screen max-w-lg mx-auto flex flex-col items-center justify-center">
      ...
      <form className="w-full my-4">
        <input
          ...
          className="h-10 pl-4 w-full mb-4 rounded-md text-sm bg-charcoal border border-neutral-800 text-typo placeholder-neutral-500 outline-none focus:outline-none active:outline-none focus:ring-2 focus:ring-neutral-800"
        />
        <input
          type="password"
...
const Divider = () => {
  return (
    <div className="relative w-full py-8">
      ...
      <div className="w-full h-px bg-dim rounded-br-xl rounded-bl-xl" />
      <div className="absolute inset-0 h-5 w-5 m-auto rounded-md px-3 py-0.5 text-xs bg-dim shadow-[0px_-1px_0px_0px_var(--neutral-700)] flex items-center justify-center">
        OR
      </div>
    </div>
  );
